...
<script lang="ts">
	...
	import UpdateSolution from '$lib/components/challenges/solutions/UpdateSolution.svelte';
...
{#if challenge && solution}
	<SEO
		title={`${challenge.name} - ${solution.user.username} Edit`}
		openGraph={{
			title: `${challenge.name} - ${solution.user.username} Edit`,
...
<UserLayout>
	{#if challenge}
		<ChallengeWrapper {challenge}>
			<UpdateSolution {challenge} {solution} />
		</ChallengeWrapper>
	{/if}
</UserLayout>
